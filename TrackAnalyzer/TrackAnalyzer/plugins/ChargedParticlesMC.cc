...
class ChargedParticlesMC : public edm::EDAnalyzer {
   public:
      explicit ChargedParticlesMC(const edm::ParameterSet&);
      ~ChargedParticlesMC();
...
ChargedParticlesMC::ChargedParticlesMC(const edm::ParameterSet& iConfig):
...
ChargedParticlesMC::~ChargedParticlesMC()
{
...
void
ChargedParticlesMC::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
...
void 
ChargedParticlesMC::printWeirdParticle( const reco::GenParticle & particle)
{
...
void 
ChargedParticlesMC::printRoguePion( const reco::GenParticle & particle, double vdist)
{
...
void
ChargedParticlesMC::beginJob()
{
}

void
ChargedParticlesMC::endJob()
{
...
DEFINE_FWK_MODULE(ChargedParticlesMC);
